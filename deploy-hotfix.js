...
const FILES_TO_SYNC = [
    ...
    { local: './app/purchasing/actions.ts', remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/purchasing/actions.ts' },
    { local: './app/purchasing/bills/PurchaseBillClient.tsx', remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/purchasing/bills/PurchaseBillClient.tsx' },
    { local: './app/purchasing/orders/PurchaseOrderClient.tsx', remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/purchasing/orders/PurchaseOrderClient.tsx' }
];
...
function triggerBuild() {
    console.log('Uploads complete. Running prisma generate, db push, build and restarting PM2...');
