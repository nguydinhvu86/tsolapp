...
export function NewQuoteClient({ templates, customers, preselectedCustomerId }: { templates: QuoteTemplate[], customers: Customer[], preselectedCustomerId?: string }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!selectedTemplate || !selectedCustomer) {
            alert('Vui lòng chọn đầy đủ Mẫu báo giá và Khách hàng');
            return;
        }
        ...
        <div className="flex" style={{ gap: '2rem', alignItems: 'flex-start' }}>
                ...
                <Card>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            <label style={{ fontWeight: 500, fontSize: '0.875rem' }}>Chọn Mẫu Báo Giá</label>
                ...
                {selectedTemplate && (
                    <Card>
                        ...
                        <div style={{ marginTop: '2rem' }}>
                            <Button onClick={handleSubmit} className="w-full">Tạo Báo Giá</Button>
                        </div>
                    </Card>
                )}
            </div>
            ...
            <div style={{ flex: 1.5 }}>
                <Card style={{ position: 'sticky', top: '80px', minHeight: '600px' }}>
                    <h3 style={{ marginBottom: '1rem', borderBottom: '1px solid var(--border)', paddingBottom: '1rem' }}>Xem trước Báo giá</h3>
                    {previewContent ? (
                        <div
                            className="ql-editor"
