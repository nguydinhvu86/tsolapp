...
export async function generateMetadata({ params }: { params: { id: string } }): Promise<Metadata> {
    ...
    const title = quote?.title ? `${quote.title} | T-SOLUTION` : 'Báo Giá | T-SOLUTION';
    const description = quote?.customer?.name 
        ? `Báo giá trực tuyến cho khách hàng ${quote.customer.name} - T-SOLUTION`
