    ...
    return (
        <div className="statement-panel">
            ...
            <div className="print-only" style={{ display: 'none', marginBottom: '2rem', textAlign: 'center' }}>
                <h1 style={{ fontSize: '1.5rem', fontWeight: 700, margin: '0 0 0.5rem 0' }}>SAO KÊ CÔNG NỢ NHÀ CUNG CẤP</h1>
                <p style={{ margin: '0 0 0.25rem 0', fontSize: '1.125rem', fontWeight: 600 }}>Nhà cung cấp: {supplierName}</p>
