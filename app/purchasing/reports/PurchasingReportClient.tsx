...
import { Calendar, TrendingUp, DollarSign, Users, Package, FileText, CreditCard, Search, ArrowUpRight, Activity } from 'lucide-react';
...
export function PurchasingReportClient({ bills, payments, orders, suppliers }: { bills: any[], payments: any[], orders: any[], suppliers: any[] }) {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'supplier' | 'product' | 'document' | 'payment'>('overview');
        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="mb-6">
                <div className="premium-tabs-wrapper">
                    ...
                    <button className={`premium-tab ${activeTab === 'document' ? 'active' : ''}`} onClick={() => setActiveTab('document')}>
                        <FileText size={16} /> Đơn Hàng & Hóa Đơn
                    </button>
