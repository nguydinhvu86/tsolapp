...
conn.on('ready', () => {
    console.log('Connected to server. Uploading Sidebar.tsx...');
    conn.sftp((err, sftp) => {
        if (err) throw err;

        const fileToUpload = {
            local: 'C:/Users/admin/Documents/CONTRACT/app/components/layout/Sidebar.tsx',
            remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/components/layout/Sidebar.tsx'
        };
