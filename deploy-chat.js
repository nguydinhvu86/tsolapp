...
conn.on('ready', () => {
    console.log('Connected to server. Uploading Chat components...');
    conn.sftp((err, sftp) => {
        if (err) throw err;

        const files = [
            {
                local: 'C:/Users/admin/Documents/CONTRACT/app/components/chat/ChatWidget.tsx',
                remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/components/chat/ChatWidget.tsx'
            },
            {
                local: 'C:/Users/admin/Documents/CONTRACT/app/components/chat/ChatWindow.tsx',
                remote: '/www/wwwroot/inside.tsol.vn/tsolapp/app/components/chat/ChatWindow.tsx'
            }
        ];
