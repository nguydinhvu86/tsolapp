...
c1 = c1.replace(/import \{ Plus, Search, Edit2, Trash2, ExternalLink \} from 'lucide-react';\r?\n/g, '');
c1 = c1.replace(/'use client';\r?\n/g, '');
c1 = "'use client';\nimport { Plus, Search, Edit2, Trash2, ExternalLink } from 'lucide-react';\n" + c1;
fs.writeFileSync(f1, c1);

let f2 = 'app/ecatalogs/[id]/EcatalogDetailClient.tsx';
let c2 = fs.readFileSync(f2, 'utf8');
c2 = c2.replace(/import \{ Plus, Search, Edit2, Trash2, ExternalLink, ArrowLeft, Save, Eye \} from 'lucide-react';\r?\n/g, '');
c2 = c2.replace(/'use client';\r?\n/g, '');
...
c3 = c3.replace(/import \{ Box, CheckCircle \} from 'lucide-react';\r?\n/g, '');
