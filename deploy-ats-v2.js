...
conn.on('ready', () => {
    ...
    conn.exec('mkdir -p /www/wwwroot/inside.tsol.vn/tsolapp/app/hr/recruitment/requisitions /www/wwwroot/inside.tsol.vn/tsolapp/app/hr/recruitment/pipeline', (err, stream) => {
        if (err) throw err;
                ...
                filesToUpload.forEach(file => {
                    sftp.fastPut(file.local, file.remote, (err) => {
                        ...
                        if (uploadedCount === filesToUpload.length) {
                            ...
                            console.log('Executing final build commands...');
