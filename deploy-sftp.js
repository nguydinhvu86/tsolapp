...
conn.on('ready', () => {
    ...
    conn.sftp((err, sftp) => {
        ...
        console.log('SFTP session opened. Transmitting deploy.tar.gz to remote host...');
        sftp.fastPut('deploy.tar.gz', '/www/wwwroot/inside.tsol.vn/tsolapp/deploy.tar.gz', (err) => {
            if (err) {
            ...
            console.log('Archive uploaded successfully! Commencing remote extraction and build...');
